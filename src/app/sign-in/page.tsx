...
export default function SignInPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    // Server action — on success Next.js redirects to /dashboard automatically.
    // We only get a return value back when there's an error.
    const result = await credentialsSignIn(email, password)
    if (result?.error) {
      setError(result.error)
      setLoading(false)
    }
    // No else needed: successful redirect unmounts this component
  }
